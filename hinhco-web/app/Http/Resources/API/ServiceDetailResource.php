...
class ServiceDetailResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'servicePackage'    => ServicePackageResource::collection(ServicePackage::whereIn('id',$this->servicePackage->pluck('service_package_id'))->where('status',1)->where('end_at','>=',now()->toDateString())->get()),
