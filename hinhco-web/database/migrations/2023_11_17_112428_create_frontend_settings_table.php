        ...
        if (FrontendSetting::count() === 0) {
            ...
            $settingsData = [
                [
                    ...
                    'key' => 'section_1',
                    'status' => '1',
                    'value' => '{"section_1":1,"title":"Your Instant Connection To Right Photographer Service","description":"Get things done with our reliable handyman service. From repairs to installations, weve got you covered. Your go-to solution for household tasks.","current_location":"on","enable_search":"on","enable_post_job":"on","enable_popular_services":"on","category_id":' . json_encode($categoryIds) . ',"enable_popular_provider":"on","provider_id":' . json_encode($providerIds) . '}',
                ],
                [
                    'type' => 'landing-page-setting',
                    'key' => 'section_2',
                ...
                [
                    ...
                    'key' => 'section_3',
                    'status' => '1',
                    'value' => '{"section_3":1,"title":"Dịch Vụ Được Đánh Giá Cao","service_id":' . json_encode($serviceIds) . '}',
                ],
                [
                    'type' => 'landing-page-setting',
                    'key' => 'section_4',
                ...
                [
                    ...
                    'key' => 'section_7',
                    'status' => '1',
                    'value' => '{"section_7":1,"title":"Advanced Solutions And Professional Workflow","description":"Efficient workflow: Plan, execute, collaborate; iterate as needed. Embrace automation, communication, and adaptability for optimal productivity.","url":"https:\/\/www.youtube.com\/watch?v=KswIQq7j_54","subtitle":["Admin To Provider","Provider To Photographer","Photographer To User"],"subdescription":["admin gives the user booking service and then contacts the provider to fulfill the user services successfully.","admin gives the user booking service and then contacts the provider to fulfill the user services successfully.","admin gives the user booking service and then contacts the provider to fulfill the user services successfully."]}',
                ],
                [
                    'type' => 'footer-setting',
                    'key' => 'footer-setting',
                ...
                [
                    ...
                    'key' => 'section_9',
                    'status' => '1',
                    'value' => '{"section_9":1,"title":"Khách Hàng Tin Tưởng Chúng Tôi","overall_rating":"on","description":"Experience perfection: 99.9% satisfied clients, 500+ reviews, and 5,068 completed services."}',
                ],
                [
                    'type' => 'login-register-setting',
                    'key' => 'login-register-setting',
                    'status' => '1',
                    'value' => '{"login_register":1,"title":"Welcome To Our Photographer","description":"Skilled handyman services like Fixing, repairing, and improving your space with expertise, making life easier, one project at a time."}',
                ],
