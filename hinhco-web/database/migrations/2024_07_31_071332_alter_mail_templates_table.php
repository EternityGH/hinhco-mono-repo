...
class AlterMailTemplatesTable extends Migration
{
    ...
    public function up()
    {
        ...
        $template->defaultMailTemplateMap()->create([
            ...
            'subject' => 'New User Registration',
            'template_detail' => '<p>Hello [[ provider_name ]],</p>
                           <p>Thank you for registering with Photographer Services. We have received your registration request and will review your information shortly. You will receive an email with further instructions once your registration is approved.</p>
                           <p>&nbsp;</p>
                           <p>Best regards,<br />[[ company_name ]]</p>',
        ]);
        $template->defaultMailTemplateMap()->create([
            ...
            'subject' => 'New User Registration',
            'template_detail' => '<p>Hello [[ handyman_name ]],&nbsp;</p>
                           <p>Thank you for registering with Photographer Services.&nbsp;</p>
