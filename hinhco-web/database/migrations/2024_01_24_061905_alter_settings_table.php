        ...
        foreach ($appsettings as $appsetting) {
            if (!empty($appsetting)) {
                ...
                $appSettingsData[] = [
                    ...
                    'key' => 'general-setting',
                    'value' => [
                        'site_name' => $appsetting->site_name ?? "Photographer Service",
                        'site_description' => $appsetting->site_description ?? "Launch your own mobile-based online On-Demand Home Services with Photographer Service mobile app. The customizable templates of this amazing app can quickly let developers set up a service booking system to accept bookings from clients from anywhere in only a few minutes. With ready-to-use Sign-in page, Sign-up pages, Payment methods page, Booking lists, Service Type demo, Photographer detail page, Coupon page, and more, this Photographer Service app allows businesses to have a complete and running booking service system app in no time. The provider in this Photographer Service app can assign the booking to Photographer and accelerate the service. This Photographer Service system app comes with a Laravel PHP admin panel to have meaningful insights from the admin dashboard and statistics. Assign multi-roles and permissions like Admin, Service Provider, Photographer, and customers using this app. Additionally, this Photographer Service app supports Multiple Language/ RTL support. This customizable, ready-to-use app comes with light as well as dark theme support and push notification to engage with clients in a more interactive way.",
                ...
                $siteSetupData['value'] = [
                    ...
                    'site_copyright' => $appsetting->site_copyright ?? "© 2024 All Rights Reserved by HINH.CO",
                ];
            }
        }
