...
return [
    ...
    | Hãy tùy chỉnh các thông báo này ở đây.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Bạn có thể chỉ định các thông báo xác thực tùy chỉnh cho các thuộc tính
    | bằng cách sử dụng quy ước "attribute.rule" để đặt tên dòng. Điều này
    | giúp dễ dàng xác định dòng thông báo tùy chỉnh cho quy tắc thuộc tính cụ thể.
    |
    */
    ...
    | bằng những từ dễ đọc như "Địa chỉ E-Mail" thay vì "email". Điều này chỉ
    | giúp các thông báo trở nên rõ ràng hơn.
    |
    */
