                        ...
                        <div class="row align-items-center">
                            <div class="col-md-8">
                                ...
                                <div>
                                    ...
                                    @if (
                                        ($bookingData['service']['is_enable_advance_payment'] == 0 &&
                                    ...
                                    @if (
                                        ...
                                        <div id="payment-component" style="display: none;">
                                            <payment :booking_id="{{ $bookingData['booking_detail']['id'] }}"
                                        ...
                                        <div class="mt-5">
                                            <a onclick="togglePayment()" id="pay_advance"
                                                ...
                                                ({{ getPriceFormat($bookingData['booking_detail']['total_amount']) }})</a>
                                        </div>
                                    @endif
                            ...
                            <div class="col-md-4 text-md-end mt-5 mt-md-0">
                                @php
                                    ...
                                    if ($bookingData['booking_detail']['booking_package'] == null) {
                                        ...
                                        $imageSource = !empty(
                                            $bookingData['booking_detail']['booking_package']['package_image']
                                        )
                                            ? $bookingData['booking_detail']['booking_package']['package_image']
                                            : null;
                                    }
                            ...
                            @foreach ($bookingData['booking_detail']['booking_package']['services'] as $servicepackage)
                                @php
                                    $category = App\Models\Category::where(
                                        'id',
                                        $servicepackage['category_id'],
                                    )->first();
                                    $subcategory = App\Models\SubCategory::where(
                                        'id',
                                        $servicepackage['subcategory_id'],
                                    )->first();
                                @endphp
                                <div
                                    ...
                                    <div class="flex-shrink-0 provider-image-container">
                                        <img src="{{ $servicepackage['attchments'][0] ?? asset('images/default.png') }}"
                                    ...
                                    <div>
                                        ...
                                        <div class="d-sm-flex gap-2 my-3">
                                            <ul
                                                ...
                                                <li class="text-primary">{{ $subcategory ? $subcategory->name : null }}
                                                </li>
                                            </ul>
                                        </div>
                    ...
                    <div class="col-lg-6 col-md-7 position-relative">
                        ...
                        <div class="row">
                            <div class="col-lg-5 col-sm-6 position-relative">
                                <h6 class="mt-0 mb-4 font-size-18 text-capitalize">{{ __('landingpage.about_provider') }}
                                </h6>
                                <div class="img flex-shrink-0 mb-4">
                                    <a href="{{ route('provider.detail', $bookingData['provider_data']['id']) }}">
                                        <img src="{{ $bookingData['provider_data']['profile_image'] }}" width="208"
                                            height="208" class="mw-100 rounded-3 object-cover" alt="about-provider">
                                    </a>
                                </div>
                                <div class="content">
                                    <a href="{{ route('provider.detail', $bookingData['provider_data']['id']) }}">
                                    ...
                                    @foreach ($bookingData['handyman_data'] as $handyman)
                                        <div class="img flex-shrink-0 mb-4">
                                            <a href="{{ route('handyman-detail', $handyman['id']) }}">
                                                <img src="{{ $handyman['profile_image'] }}" width="208"
                                                    height="208" class="mw-100 rounded-3 object-cover"
                                                    alt="about-handyman">
                                            </a>
                                        </div>
                                        ...
                                        <div class="content">
                                            ...
                                            @if ($bookingData['booking_detail']['status'] == 'completed')
                                                <handyman-rating :booking_id="{{ $bookingData['booking_detail']['id'] }}"
                                                    :service_id="{{ $bookingData['service']['id'] }}"
                                                    :customer_id="{{ auth()->user()->id }}"
                                                    :handyman_id="{{ $handyman['id'] }}"
                                                    :handymanrating="{{ isset($handymanrating) ? $handymanrating : null }}"></handyman-rating>
                                            @endif
                                        </div>
                                    @endforeach
                                </div>
                    ...
                    @if ($amount > 0)
                        <div class="col-lg-6 col-md-5 mt-md-0 mt-5">
                            <div class="position-relative px-lg-3">
                                <h6 class="mt-0 mb-3 font-size-18 text-capitalize">{{ __('landingpage.price_detail') }}
                                </h6>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                @else
                                                    <td>
                                                        <span
                                                            class="d-block text-end">{{ getPriceFormat($bookingData['booking_detail']['final_total_service_price']) }}</span>
                                                    </td>
                                                @endif
                                            </tr>
                                            ...
                                            @if ($bookingData['coupon_data'])
                                                <tr>
                                                    <td>
                                                        <span class="text-capitalize">{{ __('landingpage.coupon') }}<span
                                                                class="text-primary">
                                                                ({{ $bookingData['coupon_data']['code'] }})</span></span>
                                                    </td>


                                                    <td>
                                                        <span
                                                            class="d-block text-end text-success">-{{ getPriceFormat($bookingData['booking_detail']['final_coupon_discount_amount']) }}</span>
                                                    </td>
                                                </tr>
                                            @endif
