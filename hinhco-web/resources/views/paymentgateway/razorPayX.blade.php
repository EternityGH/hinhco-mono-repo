...
<div class="row"  id='enable_razorpay_payment'>
    ...
    <div class="form-group col-md-12">
        ...
        {{ Form::text('razorx_url',old('razorx_url'),['id'=>'razorx_url','placeholder' => trans('messages.razorx_url'),'class' =>'form-control']) }}
        <small class="help-block with-errors text-danger"></small>
    </div>
    <div class="form-group col-md-12">
        {{ Form::label('razorx_account',trans('messages.razorx_account').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false ) }}
        {{ Form::text('razorx_account',old('razorx_account'),['id'=>'razorx_account','placeholder' => trans('messages.razorx_account'),'class' =>'form-control']) }}
        <small class="help-block with-errors text-danger"></small>
    </div>
    <div class="form-group col-md-12">
        {{ Form::label('razorx_key',trans('messages.razorx_key').' <span class="text-danger">*</span>',['class'=>'form-control-label'], false ) }}
        {{ Form::text('razorx_key',old('razorx_key'),['id'=>'razorx_key','placeholder' => trans('messages.razorx_key'),'class' =>'form-control']) }}
        <small class="help-block with-errors text-danger"></small>
    </div>
    <div class="form-group col-md-12">
