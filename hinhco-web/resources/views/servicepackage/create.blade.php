                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            {{ Form::text('start_at',old('start_at'),['placeholder' => __('messages.start_at'),'class' =>'form-control min-datepicker']) }}
                            <small class="help-block with-errors text-danger"></small>
                        </div>
                        <div class="form-group col-md-4">
                            {{ Form::label('end_at',__('messages.end_at').'',['class'=>'form-control-label'], false ) }}
                            {{ Form::text('end_at',old('end_at'),['placeholder' => __('messages.end_at'),'class' =>'form-control min-datepicker']) }}
                            <small class="help-block with-errors text-danger"></small>
                        </div>
                        ...
                        <div class="form-group col-md-4" id="service_total_price">
                            {{ Form::label('original_price', __('messages.original_price'), ['class' => 'form-control-label'], false) }}
                            {{ Form::number('original_price', null, ['min' => 1, 'step' => 'any', 'placeholder' => __('messages.original_price'), 'class' => 'form-control', 'id' => 'original_price', 'readonly' => 'readonly']) }}
                            <small class="help-block with-errors text-danger"></small>
                        </div>
                        <div class="form-group col-md-4">
