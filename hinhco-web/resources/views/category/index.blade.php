        ...
        <div class="card card-block card-stretch">
          <div class="card-body p-0">
            <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
              ...
              <a href="{{ route('category.create') }}" class="float-end me-1 btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> {{ trans('messages.add_form_title',['form' => trans('messages.category')  ]) }}</a>
              @endif
            </div>
          </div>
        </div>
          ...
          <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="col-md-12">
              <form action="{{ route('category.bulk-action') }}" id="quick-action-form" class="form-disabled d-flex gap-3 align-items-center">
                ...
                <button id="quick-action-apply" class="btn btn-primary" data-ajax="true" data--submit="{{ route('category.bulk-action') }}" data-datatable="reload" data-confirmation='true' data-title="{{ __('category',['form'=>  __('category') ]) }}" title="{{ __('category',['form'=>  __('category') ]) }}" data-message='{{ __("Do you want to perform this action?") }}' disabled>{{ __('messages.apply') }}</button>
            </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', (event) => {
      ...
      window.renderedDataTable = $('#datatable').DataTable({
        ...
        autoWidth: false,
        responsive: true,
        dom: '<"row align-items-center"><"table-responsive mb-3" rt><"row align-items-center" <"col-md-6" l><"col-md-6" p>><"clear">',
        ajax: {
          "type": "GET",
