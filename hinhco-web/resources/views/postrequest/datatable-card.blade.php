<div class="bg-light p-5 rounded-3 position-relative mb-5">
    ...
    ?>
    <div>
        <img src="{{ !empty($serviceImages[0]) ? $serviceImages[0] : $baseURL . '/images/default.png' }}" alt="booking"
            class="img-fluid rounded-2 object-cover w-100 booking-img m-0">
    ...
    <ul class="list-inline mt-3 mb-0 d-flex align-items-center justify-content-between flex-wrap gap-3">
        <li>
            <span class="d-flex gap-3">
                <h6 class="text-capitalize text-body">Price: <span
                        class="text-primary">{{ getPriceFormat($data->price) }}</span></h6>
            </span>
        </li>
        <li>
