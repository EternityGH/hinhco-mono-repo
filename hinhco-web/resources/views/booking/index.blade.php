<x-master-layout>
                ...
                <div class="card card-block card-stretch">
                    <div class="card-body p-0">
                        <div class="d-flex justify-content-between align-items-center p-3 flex-wrap gap-3">
                            ...
                            <a href="{{ route('booking.create') }}" class=" float-end me-1 btn btn-sm btn-primary"><i class="fa fa-plus-circle"></i> {{ __('messages.add_form_title',['form' => __('messages.booking')  ]) }}</a>
                            @endif
                        </div>
    ...
    <script>
        ...
        window.renderedDataTable = $('#datatable').DataTable({
                ...
                ajax: {
                  "type"   : "GET",
                  "url": '{{ route("booking.index_data", ["filter" => $filter,"provider_id" => $provider_id, "handyman_id" => $handyman_id, "customer_id" => $customer_id]) }}'.replace(/&amp;/g, '&'),
                  "data"   : function( d ) {
                    d.search = {
                      value: $('.dt-search').val()
                    };
