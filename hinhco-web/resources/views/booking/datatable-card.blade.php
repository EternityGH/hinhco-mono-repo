<div class="bg-light padding-50 rounded-3 position-relative mb-5">
    <div class="row align-items-center">
        <div class="col-lg-4">
            ...
            @else
                @php
                    ...
                    $url = $media ?? asset('images/default.png');
                @endphp
        ...
        <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <div
                class="booking-date bg-primary-subtle text-primary font-size-14 d-flex align-items-center gap-1 position-absolute top-0">
                ...
                @endphp
                <span
                    class="text-capitalize font-size-14 fw-500">{{ date("$datetime->date_format $datetime->time_format", strtotime($data->date)) }}</span>
            </div>
            <div class="row mt-5">
                    ...
                    <ul class="list-inline m-0">
                        ...
                        <li>
                            <span class="d-flex gap-3">
                                ...
                                <span
                                    class="d-inline-block w-75 status-text text-success text-capitalize">{{ str_replace('_', ' ', $data->status) ?? '-' }}</span>
                            </span>
                        </li>
                    </ul>
                </div>
                        ...
                        <ul class="list-inline m-0">
                            ...
                            <li class="mb-2">
                                <span class="d-flex gap-3">
                                    ...
                                    <span
                                        class="d-inline-block w-75 text-capitalize">{{ optional($data->payment)->payment_type ?? '-' }}</span>
                                </span>
                            </li>
                            <li>
                                <span class="d-flex gap-3">
                                    ...
                                    @if (!empty($data->payment))
                                        <span
                                            class="d-inline-block w-75 status-text text-success text-capitalize">{{ str_replace('_', ' ', optional($data->payment)->payment_status) ?? '-' }}</span>
                                    @else
                                        <span
                                            class="d-inline-block w-75 status-text text-success text-capitalize">Pending</span>
                                    @endif
                                </span>
                            </li>
                        </ul>
